...
exports.constructToastContainer = function (elements) {
    return html_elements_1.createSanitizedElement('div', ['beacon-toast__base', 'animated', 'fadeIn'], [['id', 'beacon-toast']], [
        html_elements_1.createSanitizedElement('div', ['beacon-toast__content'], [], [
            html_elements_1.createSanitizedElement('span', [], [['id', 'beacon-text']], [
                html_elements_1.createSanitizedElement('p', [], [['id', 'beacon-text-content']], elements),
                html_elements_1.createSanitizedElement('a', ['beacon-toast__wallet__link'], [['id', 'beacon-open-wallet']], [
                    html_elements_1.createSanitizedElement('span', [], [], 'Open'),
                    html_elements_1.createSVGElement(['svg-inline--fa', 'fa-external-link-alt', 'fa-w-16'], [
                        ['aria-hidden', 'true'],
                        ['focusable', 'false'],
                        ['data-prefix', 'fas'],
                        ...
                        html_elements_1.createSVGPathElement([
                            ['fill', 'currentColor'],
                            [
                                'd',
            ...
            html_elements_1.createSVGElement(['beacon-toast__more', 'svg-inline--fa', 'fa-angle-down', 'fa-w-10'], [
            ...
            html_elements_1.createSVGElement(['beacon-toast__more', 'svg-inline--fa', 'fa-times', 'fa-w-10'], [
        ...
        html_elements_1.createSanitizedElement('div', ['progress-line'], [['id', 'beacon-toast-loader']], ''),
        html_elements_1.createSanitizedElement('hr', ['hide'], [['id', 'beacon-toast-loader-placeholder']], ''),
        html_elements_1.createSanitizedElement('div', ['beacon-toast__more--action'], [['id', 'beacon-toast-list']], '')
    ]);
};
exports.constructPoweredByBeacon = function () {
    return html_elements_1.createSanitizedElement('a', [], [
        ['href', 'https://walletbeacon.io'],
        ['target', '_blank']
    ], [
        document.createTextNode('powered by'),
        html_elements_1.createSVGElement([], [
            ...
            html_elements_1.createSanitizedElement('title', [], [], 'beacon_logo'),
            html_elements_1.createSVGPathElement([
                ['fill', 'currentColor'],
                [
                    'd',
...
exports.constructAlertContainer = function (id, callToAction, buttons, main) {
    return html_elements_1.createSanitizedElement('div', ['beacon-alert__base', 'animated', 'fadeIn'], [['id', "beacon-alert-modal-" + id]], [
        html_elements_1.createSanitizedElement('div', ['beacon-modal__wrapper'], [], [
            html_elements_1.createSanitizedElement('div', ['beacon-modal__header'], [], [
                html_elements_1.createSVGElement([], [
                    ['xmlns', 'http://www.w3.org/2000/svg'],
                    ['id', 'Guides'],
                    ['x', '0'],
                    ...
                    html_elements_1.createSanitizedElement('style', [], [], ".st0 {\n                    fill: #3880ff;\n                  }\n                  .st1 {\n                    fill: #fff;\n                  }"),
                    html_elements_1.createSVGPathElement([
                        [
                            'd',
                    ...
                    html_elements_1.createSVGGElement([
                        html_elements_1.createSVGPathElement([
                            [
                                'd',
                ...
                html_elements_1.createSanitizedElement('div', ['beacon-modal__close__wrapper'], [['id', "beacon-alert-" + id + "-close"]], [
                    html_elements_1.createSanitizedElement('div', ['beacon-modal__close__icon'], [], [
                        html_elements_1.createSanitizedElement('div', ['beacon-modal__close__line1'], [], []),
                        html_elements_1.createSanitizedElement('div', ['beacon-modal__close__line2'], [], [])
                    ])
                ])
            ]),
            html_elements_1.createSanitizedElement('div', ['beacon-modal__base'], [], [
                html_elements_1.createSanitizedElement('div', [], [['id', 'beacon-modal__content']], [
                    html_elements_1.createSanitizedElement('div', [], [], __spreadArrays([
                        html_elements_1.createSanitizedElement('p', ['beacon-alert__title'], [], callToAction)
                    ], main, [
                        html_elements_1.createSanitizedElement('div', ['beacon-action__container'], [], buttons)
                    ]))
                ])
            ])
        ])
...
exports.constructDefaultAlert = function (id, callToAction, buttons, main) {
    return exports.constructAlertContainer(id, callToAction, buttons, [
        html_elements_1.createSanitizedElement('div', ['beacon-alert__text'], [['id', 'beacon-main-text']], main)
    ]);
};
exports.constructPairAlert = function (id, callToAction, buttons, main) {
    return exports.constructAlertContainer(id, callToAction, buttons, [
        html_elements_1.createSanitizedElement('span', [], [['id', 'pairing-container']], ''),
        html_elements_1.createSanitizedElement('div', ['beacon-alert__text'], [['id', 'beacon-main-text']], [
            html_elements_1.createSanitizedElement('p', ['beacon-list__title'], [['id', 'beacon-title']], __spreadArrays([
                document.createTextNode('Scan QR code with a Beacon-compatible wallet.\u00A0'),
                html_elements_1.createSanitizedElement('a', [], [
                    ['href', 'https://docs.walletbeacon.io/supported-wallets'],
                    ['target', '_blank']
                ], 'Learn more')
            ], main))
        ]),
        html_elements_1.createSanitizedElement('div', [], [['id', 'beacon--switch__container']], [
            html_elements_1.createSanitizedElement('button', ['beacon-modal__button--outline'], [['id', 'beacon-switch']], '')
        ]),
        html_elements_1.createSanitizedElement('div', [], [['id', 'beacon--disclaimer']], '')
    ]);
};
