...
exports.createSanitizedElement = function (type, classes, attributes, element) {
    var _a;
    var el = document.createElement(type);
    if (classes.length > 0) {
        // Filter empty classnames and add all classes to element
        (_a = el.classList).add.apply(_a, classes.filter(function (clazz) { return !!clazz; }).map(function (clazz) { return exports.sanitizeText(clazz); }));
    }
    // Add all attributes to element
    attributes.forEach(function (attribute) {
        el.setAttribute(exports.sanitizeText(attribute[0]), exports.sanitizeText(attribute[1]));
    });
...
exports.createSVGElement = function (classes, attributes, element) {
    var _a;
...
exports.createSVGPathElement = function (attributes) {
...
exports.createSVGGElement = function (element) {
...
exports.createIconSVGExternal = function () {
    return exports.createSVGElement(['svg-inline--fa', 'fa-external-link-alt', 'fa-w-16'], [
        ['aria-hidden', 'true'],
        ['focusable', 'false'],
        ['data-prefix', 'fas'],
