            ...
            return __generator(this, function (_a) {
                fn = function (event) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            case 0:
                                if (event.source !== MockWindow_1.windowRef || event.origin !== MockWindow_1.windowRef.location.origin) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                MockWindow_1.windowRef.addEventListener('message', function (message) {
                    if (message.source !== MockWindow_1.windowRef ||
                        message.origin !== MockWindow_1.windowRef.location.origin) {
                        // TODO: Add to error handler: console.debug('[Beacon]: Event received from untrusted origin')
                        return;
                    }
