        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                wrapBold = function (element) {
                    return html_elements_1.createSanitizedElement('strong', [], [], element);
                };
                if (actionCallback) {
                    if (text.length > 0) {
                        wrapper.appendChild(html_elements_1.createSanitizedElement('p', [], [], text));
                    }
                    textEl = html_elements_1.createSanitizedElement('span', [], [], [
                        html_elements_1.createSanitizedElement('span', [], [], actionText),
                        actionLogo && actionLogo === 'external' ? html_elements_1.createIconSVGExternal() : undefined
                    ]);
                    wrapper.appendChild(html_elements_1.createSanitizedElement('p', [], [], [html_elements_1.createSanitizedElement('a', [], [['id', id]], [isBold ? wrapBold([textEl]) : textEl])]));
                }
                else if (actionText) {
                    if (text.length > 0) {
                        wrapper.appendChild(html_elements_1.createSanitizedElement('p', ['beacon-toast__action__item__subtitle'], [], text));
                    }
                    textEl = html_elements_1.createSanitizedElement('span', [], [], actionText);
                    wrapper.appendChild(html_elements_1.createSanitizedElement('p', [], [], [isBold ? wrapBold([textEl]) : textEl]));
                }
                else {
                    textEl = html_elements_1.createSanitizedElement('p', [], [], text);
...
var formatToastText = function (html) {
    ...
    var walletEl;
    var walletNameEl = html_elements_1.createSanitizedElement('strong', [], [], walletName !== null && walletName !== void 0 ? walletName : 'Wallet');
    if (walletIcon) {
        walletEl = html_elements_1.createSanitizedElement('span', ['beacon-toast__wallet__container'], [], [
            html_elements_1.createSanitizedElement('img', ['beacon-toast__content__img'], [['src', walletIcon]], ''),
            walletNameEl
        ]);
    }
    else {
    ...
    if (splits.length === 1) {
        return [html_elements_1.createSanitizedElement('span', [], [], html)];
    }
    else {
        var out = [];
        for (var x = 0; x < splits.length; x++) {
            out.push(html_elements_1.createSanitizedElement('span', [], [], splits[x]));
...
var getToastHTML = function (config) {
    ...
    var outerEl = html_elements_1.createSanitizedElement('span', ['beacon-toast__wallet__outer'], [], elements);
    var toastContainerEl = templates_1.constructToastContainer([outerEl]);
    return {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                poweredByBeacon.appendChild(templates_1.constructPoweredByBeacon());
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                if (toastTextEl) {
                    ...
                    toastTextEl.appendChild(html_elements_1.createSanitizedElement('span', ['beacon-toast__wallet__outer'], [], formatToastText(toastConfig.body)));
                }
                openWalletButtonEl = shadowRoot.getElementById('beacon-open-wallet');
                if (openWalletButtonEl) {
                    if (toastConfig.openWalletAction) {
