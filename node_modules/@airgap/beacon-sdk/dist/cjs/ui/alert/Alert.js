...
var addQR = function (dataString) {
    if (typeof dataString === 'string') {
        return html_elements_1.createSanitizedElement('div', [], [['id', 'beacon--qr__container']], [
            html_elements_1.createSanitizedElement('div', [], [['id', 'beacon--qr__copy__container']], [
                html_elements_1.createSanitizedElement('button', ['beacon-modal__button--outline'], [['id', 'beacon--qr__copy']], 'Copy')
            ])
        ]);
    }
    return html_elements_1.createSanitizedElement('span', [], [], '');
};
var formatAlert = function (id, body, title, buttons, hasPairingPayload) {
    ...
    var buttonsHtml = buttons.map(function (button, index) {
        return html_elements_1.createSanitizedElement('button', ["beacon-modal__button" + (button.style === 'outline' ? '--outline' : '')], [['id', "beacon-alert-" + id + "-" + index]], button.text);
    });
    ...
    var callToActionEl = html_elements_1.createSanitizedElement('span', [], [], callToAction);
    var alertEl = hasPairingPayload
        ? templates_1.constructPairAlert(id, [callToActionEl], buttonsHtml, [body])
        : templates_1.constructDefaultAlert(id, [callToActionEl], buttonsHtml, [body]);
    return {
        style: allStyles,
        html: alertEl
    };
        ...
        switch (_d.label) {
            ...
            case 2:
                ...
                formattedBody = pairingPayload
                    ? addQR(body)
                    : html_elements_1.createSanitizedElement('span', [], [], body !== null && body !== void 0 ? body : '');
                if (data) {
                    formattedBody = html_elements_1.createSanitizedElement('span', [], [], [formattedBody, html_elements_1.createSanitizedElement('pre', [], [['style', 'text-align: left']], data)]);
                }
