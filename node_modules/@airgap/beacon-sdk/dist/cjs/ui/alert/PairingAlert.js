            ...
            case 1:
                ...
                info.buttons.forEach(function (button) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                randomId = _a.sent();
                                titleEl = html_elements_1.createSanitizedElement('div', ['beacon-list__title'], [], button.title);
                                buttonEl = html_elements_1.createSanitizedElement('button', ['beacon-modal__button', 'connect__btn'], [], button.text);
                ...
                showWallet = function (listEl, type, wallet) {
                    ...
                    var logoEl = wallet.logo
                        ? html_elements_1.createSanitizedElement('div', [], [], [html_elements_1.createSanitizedElement('img', ['beacon-selection__img'], [['src', wallet.logo]], '')])
                        : html_elements_1.createSVGElement(['beacon-selection__img', 'svg-inline--fa', 'fa-wallet', 'fa-w-16'], [
                            ['aria-hidden', 'true'],
                            ['focusable', 'false'],
                            ['data-prefix', 'fas'],
                            ['data-icon', 'wallet'],
                    ...
                    var nameEl = html_elements_1.createSanitizedElement('div', ['beacon-selection__name'], [], [
                        html_elements_1.createSanitizedElement('span', [], [], wallet.name),
                        wallet.enabled ? undefined : html_elements_1.createSanitizedElement('p', [], [], 'Not installed')
                    ]);
                    var linkEl = html_elements_1.createSanitizedElement('a', ['beacon-selection__list', wallet.enabled ? '' : 'disabled'], [
                        ['tabindex', '0'],
                    ...
                    var completeHandler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            if (modalEl && type !== Pairing_1.WalletType.EXTENSION && type !== Pairing_1.WalletType.IOS) {
                                html_elements_1.removeAllChildren(modalEl);
                                modalEl.appendChild(html_elements_1.createSanitizedElement('p', ['beacon-alert__title'], [], 'Establishing Connection..'));
                                modalEl.appendChild(html_elements_1.createSanitizedElement('div', ['progress-line'], [['id', 'beacon-toast-loader']], ''));
                                modalEl.appendChild(html_elements_1.createSanitizedElement('div', ['beacon--selected__container'], [], __spreadArrays((wallet.logo
                                    ? [
                                        html_elements_1.createSanitizedElement('img', ['beacon-selection__img'], [['src', wallet.logo]], ''),
                                        html_elements_1.createSanitizedElement('img', ['beacon--selection__name__lg'], [], wallet.name)
                                    ]
                                    : []))));
                            }
                            return [2 /*return*/];
                ...
                showWalletLists = function (walletLists) {
                    html_elements_1.removeAllChildren(listContainer);
                    walletLists.forEach(function (list) {
                        ...
                        listWrapperEl.appendChild(html_elements_1.createSanitizedElement('div', ['beacon-list__title'], [], list.title));
