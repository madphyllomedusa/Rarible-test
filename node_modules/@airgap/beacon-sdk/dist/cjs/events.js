...
var showInternalErrorAlert = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                buttons = __spreadArrays(((_a = data.buttons) !== null && _a !== void 0 ? _a : []));
            ...
            case 0:
                ...
                return [4 /*yield*/, Toast_1.openToast({
                        ...
                        actions: [
                            {
                                text: 'Address',
                                actionText: shorten_string_1.shortenString(output.address),
                                isBold: true
                            },
                            {
                                text: 'Network',
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Toast_1.openToast({
                        ...
                        actions: [
                            {
                                text: shorten_string_1.shortenString(output.transactionHash),
                                isBold: true,
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Toast_1.openToast({
                        ...
                        actions: [
                            {
                                text: "Signature: " + shorten_string_1.shortenString(output.signature),
