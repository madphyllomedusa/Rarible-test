...
exports.localForger = exports.LocalForger = exports.getCodec = exports.VERSION = exports.ProtocolsHash = exports.CODEC = void 0;
...
function getCodec(codec, proto) {
    if (proto === constants_1.ProtocolsHash.Psithaca2) {
        return {
...
class LocalForger {
    constructor(protocolHash = constants_1.ProtocolsHash.Psithaca2) {
