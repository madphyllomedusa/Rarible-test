...
export declare const createNewPollingBasedHeadObservable: (sharedHeadOb: Observable<BlockResponse>, context: Context, scheduler?: SchedulerLike | undefined) => Observable<BlockResponse>;
