...
class Wallet {
    ...
    setDelegate(params) {
        if (params.delegate && utils_1.validateAddress(params.delegate) !== utils_1.ValidationResult.VALID) {
            throw new utils_1.InvalidAddressError(`Invalid address error: ${params.delegate}`);
        }
        return this.walletCommand(() => __awaiter(this, void 0, void 0, function* () {
    ...
    at(address, contractAbstractionComposer = (x) => x) {
        return __awaiter(this, void 0, void 0, function* () {
            if (utils_1.validateContractAddress(address) !== utils_1.ValidationResult.VALID) {
                throw new utils_1.InvalidContractAddressError(`Invalid contract address: ${address}`);
            }
