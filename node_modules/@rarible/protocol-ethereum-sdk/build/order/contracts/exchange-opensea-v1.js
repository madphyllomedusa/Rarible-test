...
exports.OPENSEA_EXCHANGE_ABI = exports.createOpenseaContract = void 0;
function createOpenseaContract(ethereum, address) {
    return ethereum.createContract(exports.OPENSEA_EXCHANGE_ABI, address);
}
exports.createOpenseaContract = createOpenseaContract;
exports.OPENSEA_EXCHANGE_ABI = [
    {
        "constant": true,
        "inputs": [],
        "name": "name",
