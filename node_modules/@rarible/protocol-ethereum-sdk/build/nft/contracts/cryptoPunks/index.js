...
exports.cryptoPunksAbi = exports.createCryptoPunksMarketContract = void 0;
function createCryptoPunksMarketContract(ethereum, address) {
    return ethereum.createContract(exports.cryptoPunksAbi, address);
}
exports.createCryptoPunksMarketContract = createCryptoPunksMarketContract;
exports.cryptoPunksAbi = [{
        "constant": true,
        "inputs": [],
        "name": "name",
        "outputs": [{
