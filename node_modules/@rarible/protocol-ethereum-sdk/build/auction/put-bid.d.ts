...
export declare type PutBidRequest = {
    hash: string;
    priceDecimal: BigNumber;
    originFees?: Part[];
};
export declare type PutAuctionBidAction = Action<"approve" | "sign", PutBidRequest, EthereumTransaction>;
export declare class PutAuctionBid {
    ...
    readonly putBid: PutAuctionBidAction;
